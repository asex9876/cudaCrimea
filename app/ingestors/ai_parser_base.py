...
This module provides a base class and utilities for parsing events from ANY source
(websites, APIs, Telegram channels, etc.) using AI for accurate data extraction.
"""
